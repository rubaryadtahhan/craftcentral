...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:root@localhost/craftCentral?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:root@localhost/craftCentral?new_link=true');
  }
}
...
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Applications/MAMP/htdocs/drupal/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '07777dfd914dafaa72ee7ad5bd4bac80');
}
...
// define( 'CIVICRM_MAIL_LOG', '/Applications/MAMP/htdocs/drupal/sites/default/files/civicrm/templates_c//mail.log');
// }
